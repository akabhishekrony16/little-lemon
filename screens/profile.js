...
function SaveChanges(){
  if (!Validate_PhoneNumber(phone)){
   return  Alert.alert("Incorrect Phone Number")
      ...
      return Alert.alert("Saved Sucessfully!!!")
  ...
  useEffect(() => {
    getData();
  }, [firstname,email,lastname,phone,image]);
  ...
  if(image===null){
    ...
    <View style={{marginLeft:20,marginRight:20,marginTop:20}}>
      ...
      <Text style = {{backgroundColor:'#10b6c2',padding:30,borderRadius:50,color:'white',fontSize:30}}>{firstname.slice(0,1)}{lastname.slice(0,1)}</Text>
    ...
    return (
      ...
      <ScrollView >
    <View style={{marginLeft:20,marginRight:20,marginTop:20}}>
      <Text style = {{fontWeight:'300'}}>Avatar</Text>
      <View style={{ flex: 1, alignItems:'center', justifyContent:'flex-start',flexDirection:'row',marginTop:10}}>
      <Image source={{ uri: image }} style={{ width:100, height:100,borderRadius:50,resizeMode:'contain',alignSelf:'center',}} />
